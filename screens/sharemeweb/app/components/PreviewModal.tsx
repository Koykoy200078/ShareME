...
export default function PreviewModal({ file, onClose }: Props) {
	...
	// Same-origin URL through the app/files route handler proxy.
			...
			<div className='preview-content' onClick={(e) => e.stopPropagation()}>
				...
				<div className='preview-header'>
					...
					<div className='preview-header-actions'>
						<a href={fileUrl} download={file.name} className='btn-open-tab' title='Download file' onClick={(e) => e.stopPropagation()}>
							⬇ Download
						</a>
						<a href={fileUrl} target='_blank' rel='noopener noreferrer' className='btn-open-tab' title='Open in new tab' onClick={(e) => e.stopPropagation()}>
							↗ New Tab
						</a>
				...
				<div id='previewContainer' className='preview-container'>
					{isImage && <img src={fileUrl} alt={file.name} className='preview-image' />}

					{isVideo && <video src={fileUrl} controls autoPlay className='preview-video' />}
